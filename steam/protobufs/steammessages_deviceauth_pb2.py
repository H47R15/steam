...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DEVICEAUTH'].methods_by_name['AcceptAuthorizationRequest']._serialized_options = b'\202\265\0300Accept an authorization request by another users'
  _globals['_DEVICEAUTH'].methods_by_name['AuthorizeRemoteDevice']._loaded_options = None
  _globals['_DEVICEAUTH'].methods_by_name['AuthorizeRemoteDevice']._serialized_options = b'\202\265\0304Authorize own remote device that has pending request'
